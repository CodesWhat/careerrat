...
export const WORKSPACE_INTENT_ENTITY_TYPES = Object.freeze({
  ...
  "coaching.plan": ["application"],
  "coaching.evidence-save": ["application"],
  ...
  "status.connect-portal-request": ["workspace"],
  "status.connect-portal": ["application"],
...
function intentText(intent) {
  const descriptions = {
    ...
    "coaching.plan": "Coach me on this fit",
    "coaching.evidence-save": "Add this to my evidence",
    ...
    "status.connect-portal-request": "Resolve and connect this status portal",
    "status.connect-portal": "Connect this application status portal",
