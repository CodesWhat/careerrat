...
key-files:
  created:
    ...
    - .planning/phases/06-canonical-db-app-shell/06-01-SUMMARY.md
  modified: []
...
- `.planning/phases/06-canonical-db-app-shell/06-01-SUMMARY.md` - Plan execution summary and coverage metadata.
...
- Verified `.planning/phases/06-canonical-db-app-shell/06-01-SUMMARY.md` exists.
