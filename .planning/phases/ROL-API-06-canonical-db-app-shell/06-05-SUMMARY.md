...
key-files:
  created:
    ...
    - .planning/phases/ROL-API-06-canonical-db-app-shell/deferred-items.md
  modified:
...
- `.planning/phases/ROL-API-06-canonical-db-app-shell/deferred-items.md` - Records the out-of-scope 06-06 static guard finding for `boards-route.mjs`.
- `.planning/phases/ROL-API-06-canonical-db-app-shell/06-05-SUMMARY.md` - Plan execution summary and coverage metadata.
...
- Verified `.planning/phases/ROL-API-06-canonical-db-app-shell/06-05-SUMMARY.md` exists.
- Verified `.planning/phases/ROL-API-06-canonical-db-app-shell/deferred-items.md` exists.
