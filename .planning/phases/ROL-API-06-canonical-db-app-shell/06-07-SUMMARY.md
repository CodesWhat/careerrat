...
key-files:
  created:
    ...
    - .planning/phases/ROL-API-06-canonical-db-app-shell/06-07-SUMMARY.md
  modified:
...
- `.planning/phases/ROL-API-06-canonical-db-app-shell/06-07-SUMMARY.md` - Plan execution summary and coverage metadata.
