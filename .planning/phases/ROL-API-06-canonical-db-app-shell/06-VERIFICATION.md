...
| `node /Users/sbenson/.codex/gsd-core/bin/gsd-tools.cjs check verify.schema-drift ROL-API-06-canonical-db-app-shell --raw` | Passed: no schema drift |
| `node /Users/sbenson/.codex/gsd-core/bin/gsd-tools.cjs check verify.codebase-drift ROL-API-06-canonical-db-app-shell --raw` | Skipped: no structure map, non-blocking |
| `node /Users/sbenson/.codex/gsd-core/bin/gsd-tools.cjs check ui.safety-gate ROL-API-06-canonical-db-app-shell --raw` | Non-blocking pass: no UI-spec gate block |
| `node /Users/sbenson/.codex/gsd-core/bin/gsd-tools.cjs check tdd.review-checkpoint ROL-API-06-canonical-db-app-shell --raw` | Passed/skipped: no type:tdd plans |
