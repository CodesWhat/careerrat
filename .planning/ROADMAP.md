...
| 9 | Public Company Intelligence and Scanner Cascade | Build privacy-scrubbed public company/job-board intelligence and deepen non-ATS discovery. | PUB-01, PUB-02, PUB-03, DSC-01, DSC-02, DSC-03 | In Progress (2/6) |
...
- [ ] 09-03-PLAN.md — Implement deterministic scanner cascade and local scan route.
- [ ] 09-04-PLAN.md — Add bounded AI fallback for genuinely ambiguous public pages.

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 09-05-PLAN.md — Add public-intel review queue, decisions, and UI affordances.
- [ ] 09-06-PLAN.md — Add privacy/runtime guards, docs, and final verification.
