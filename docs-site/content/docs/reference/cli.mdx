---
title: CLI Commands
description: Every public CareerRat CLI command plus maintainer-only npm scripts.
---
...
|----------|---------|---------|
| `CAREERRAT_HOME` | `<repo root>` | Override location of `candidate/` and `workspace/` (legacy `ROLESTER_HOME` still honored) |
