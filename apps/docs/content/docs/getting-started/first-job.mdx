...
Ask CareerRat to search for a real role family and location. Engineering and
hospitality both use deterministic public sources plus broad AI open-web
discovery. A credible AI result with no readable full description should still
