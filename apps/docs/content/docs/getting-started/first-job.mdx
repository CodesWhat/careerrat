...
so I can use it?” Yes opens that exact saved search in the visible app browser.
No skips it and keeps the rest of the search moving. You do not need to find a
search permission switch in Settings.
