...
import { handleDialogKeyDown, useDialogFocus } from "../lib/use-dialog-focus.js";

// Focus trap / Escape / focus-return behavior now lives in the shared
// use-dialog-focus hook (SubmitGateModal and EngineDownCover in
// chat-first/conversation-surfaces.jsx use the same one); this re-export
// keeps the name existing callers and tests already import.
export const handleArtifactViewerKeyDown = handleDialogKeyDown;

export function ArtifactViewerModal({ title, artifact, onClose }) {
  const dialogRef = useRef(null);
  useDialogFocus({ active: Boolean(artifact), dialogRef, onClose });
