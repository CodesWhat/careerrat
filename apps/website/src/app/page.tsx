        ...
        <section className="section" id="how-it-works" aria-labelledby="how-title">
          ...
          <div className="steps-grid">
            ...
            <article className="step-card">
              ...
              <p>Search opens when setup is ready. Built-in job-board sources join AI open-web discovery for the roles you set, while CareerRat discovers additional specialist boards and employer pages for your search. If a saved site needs a login, CareerRat asks “Do you want to log into LinkedIn so I can use it?” Yes opens that exact search in the visible app browser; No skips it and keeps searching elsewhere. AI discoveries are clearly unverified until Evaluate reads the full posting for location, office days, pay, and fit. It fills safe application fields only after you review missing answers. Voluntary questions stay blank by default; local Application defaults can choose a decline option when available. CAPTCHAs and Submit stay with you.</p>
