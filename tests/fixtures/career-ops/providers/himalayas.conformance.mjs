...
try {
  const himalayasModule = await import(
    pathToFileURL(join(ROOT, "src/core/providers/career-ops/vendor/himalayas.mjs")).href
  );
  ...
  if (jobs.length === 2)
    pass("parseHimalayasResponse keeps 2 jobs (drops missing/off-host/http/blank-title rows)");
