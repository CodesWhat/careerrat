...
try {
  const jobicyModule = await import(
    pathToFileURL(join(ROOT, "src/core/providers/career-ops/vendor/jobicy.mjs")).href
  );
  ...
  if (jobs.length === 2)
    pass("parseJobicyResponse keeps 2 jobs (drops missing/invalid url and empty title)");
