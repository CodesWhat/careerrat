...
try {
  const mod = await import(
    pathToFileURL(join(ROOT, "src/core/providers/career-ops/vendor/oraclecloud.mjs")).href
  );
  ...
  if (
    hit &&
    hostOf(hit.url) === "jpmc.fa.oraclecloud.com" &&
  ...
  if (
    hit &&
    hit.url.includes("finder=findReqs;siteNumber=CX_1002,") &&
    !hit.url.includes("findReqs,siteNumber")
  ) {
  ...
  const regionHit = oc.detect({
    name: "Oracle",
    careers_url:
      "https://oracle.fa.us2.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1001/jobs",
  });
  ...
  // ocs host variant
  const ocsHit = oc.detect({
    name: "X",
    careers_url: "https://acme.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
  });
  ...
  const numberedShapes = [
    [
      "plain",
      "https://acme.fa.oraclecloud26.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
      "acme.fa.oraclecloud26.com",
    ],
    [
      "<region>",
      "https://acme.fa.us2.oraclecloud26.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
      "acme.fa.us2.oraclecloud26.com",
    ],
    [
      ".ocs.",
      "https://acme.fa.ocs.oraclecloud26.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
      "acme.fa.ocs.oraclecloud26.com",
    ],
  ];
  ...
  if (numberedBad.length === 0) {
    pass(
      "oraclecloud.detect() handles the numbered apex (oraclecloud26.com) on all three host shapes"
    );
  } else {
  ...
  const apexUrl = (apex) =>
    `https://acme.fa.ocs.${apex}.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs`;
  const acceptedApexes = [
    "oraclecloud",
    "oraclecloud1",
    "oraclecloud9",
    "oraclecloud26",
  ...
  if (apexMisses.length === 0) {
    pass(
      "oraclecloud host pin is a BOUNDED apex family (1-99 accepted; 0, 01, 100, suffixed → null)"
    );
  } else {
  ...
  if (
    oc.detect({
      name: "Spoof3",
      careers_url:
        "https://x.fa.ocs.oraclecloud26.evil.example/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  if (
    oc.detect({
      name: "Spoof4",
      careers_url: "https://evil.example/x.fa.ocs.oraclecloud26.com/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  if (
    oc.detect({
      name: "Spoof5",
      careers_url:
        "https://acme.fa.ocs.oraclecloud26.com@evil.example/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  if (
    oc.detect({
      name: "Spoof6",
      careers_url:
        "https://acme.fa.ocs.oraclecloud26.net/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  if (
    oc.detect({
      name: "X",
      careers_url:
        "http://acme.fa.ocs.oraclecloud26.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  const noSite = oc.detect({
    name: "X",
    careers_url: "https://acme.fa.oraclecloud.com/hcmUI/CandidateExperience/en/",
  });
  ...
  if (
    apiPinned &&
    hostOf(apiPinned.url) === "tenant.fa.oraclecloud.com" &&
    apiPinned.url.includes("siteNumber=CX_1005")
  ) {
  ...
  if (
    oc.detect({
      name: "Spoof",
      careers_url:
        "https://x.fa.oraclecloud.com.evil.example/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  if (
    oc.detect({
      name: "Spoof2",
      careers_url: "https://evil.example/x.fa.oraclecloud.com/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  if (
    oc.detect({
      name: "X",
      careers_url: "http://jpmc.fa.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs",
    }) === null
  ) {
  ...
  const okJobs = await oc.fetch(
    { name: "JPMC", careers_url: careers, max_pages: 1 },
    {
      ...
      fetchJson: async (url, opts) => {
        ...
        capturedOpts = opts;
        return {
          items: [{ TotalJobsCount: 1, requisitionList: [{ Id: "5", Title: "Solo" }] }],
          hasMore: false,
        };
      },
    }
  ...
  if (
    capturedUrl &&
    hostOf(capturedUrl) === "jpmc.fa.oraclecloud.com" &&
      ...
      fetchJson: async (url) => {
        ...
        if (offset === 0) {
          return {
            items: [
              {
                TotalJobsCount: 450,
                requisitionList: Array.from({ length: 200 }, (_, i) => ({
                  Id: `A${i}`,
                  Title: `Role ${i}`,
                })),
              },
        ...
        return {
          items: [
            {
              TotalJobsCount: 450,
              requisitionList: Array.from({ length: 50 }, (_, i) => ({
                Id: `C${i}`,
                Title: `Role ${i}`,
              })),
            },
      ...
      fetchJson: async (url) => {
        ...
        return {
          items: [
            {
              TotalJobsCount: 350,
              requisitionList: Array.from({ length: len }, (_, i) => ({
                Id: `H${offset}-${i}`,
                Title: `R${i}`,
              })),
            },
  ...
  const retried = await oc.fetch(
    { name: "RetryCo", careers_url: careers, max_pages: 1 },
    {
      ...
      fetchJson: async () => {
        ...
        return {
          items: [{ TotalJobsCount: 1, requisitionList: [{ Id: "7", Title: "Recovered" }] }],
          hasMore: false,
        };
      },
    }
